...
public class UnblockedGeographie : MonoBehaviour//Class use for undlocked the Geo subject 
{
    ...
    private void Start()
    {
        ...
        isUnblocked = PlayerPrefs.GetInt("UnblockedGeo");
        if (isUnblocked == 1)
        {
    ...
    private void SaveBuy()
    {
        ...
        PlayerPrefs.SetInt("UnblockedGeo", isUnblocked);
    }
